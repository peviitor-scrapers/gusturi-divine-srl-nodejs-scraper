 ...
 *
 * Quick nightly cleanup pass over jobs in the peviitor API. Uses HEAD requests only.
 ...
 * at the scraper/ directory.
 *
 * Flags:
 *   --dry-run    Show invalid jobs but do not delete
 *   --delete     Delete invalid jobs from the API after listing
 */
